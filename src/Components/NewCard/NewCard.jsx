            ...
            <div className="newcard-container">
              ...
              <form>
                ...
                <div className="newcard-form-buttons">
                  <input className="new-card-create-button" type="button" value="CREATE" onClick={() => {if(nameRef.current.value === "" || nameRef.current.value === " " || sublineRef.current.value === "" || sublineRef.current.value === " ") return; props.setCreatingNewCard(false); props.creatNewCard(nameRef.current.value, sublineRef.current.value); props.setUpdateDate(true); props.setUpdateDate(false);}}/>
